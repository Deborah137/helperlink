...
function makeCar(name, doors, make, model) {
  return {
    name: name,
    doors: doors,
    make: make,
...
const car1 = makeCar("Car 1", 2, "Ford", "mustang");
printCar(car1);

const car2 = makeCar("Car 2", 4, "Toyota", "camry");
printCar(car2);

const car3 = makeCar("Car 3", 2, "Chevrolet", "corvette");
printCar(car3);
